<template>
  <div>
    ...
    <div class="like-collect">
      <i v-if="exhibition.like==false" class="iconfont icon-dianzan" style="font-size: 30px; cursor: pointer" @click="like">
      </i>
      <i v-else class="iconfont icon-dianzan1" style="font-size: 30px; cursor: pointer" @click="cancelLike">
      </i>
      <span style="font-size: 25px;= margin-right: 15px">
        {{exhibition.likesNum}}
      </span>
      <i v-if="exhibition.collection==false" class="el-icon-star-off" style="font-size: 30px; cursor: pointer" @click="collect">
      </i>
      <i v-else class="el-icon-star-on" style="font-size: 30px; cursor: pointer" @click="cancelCollect">
      </i>
      <span style="font-size: 25px; margin-right: 15px">
        {{exhibition.collectionNum}}
      </span>
      <el-button class="threed-button" @click="go3D()">
        3D游览
      </el-button> 
    </div>
        ...
        <el-col :span="12">
          ...
          <el-row>
            ...
            <el-col :span="8" align="right">
                ...
                <div class="like-collect">
                  <i v-if="picture.like==false" class="iconfont icon-dianzan" style="font-size: 20px; cursor: pointer" @click="likePic(picture.id)">
                  </i>
                  <i v-else class="iconfont icon-dianzan1" style="font-size: 20px; cursor: pointer" @click="cancelLikePic(picture.id)">
                  </i>
                  <span style="font-size: 15px;">
                    {{picture.likesNum}}
                  </span>
                  <i v-if="picture.collection==false" class="el-icon-star-off" style="font-size: 20px; cursor: pointer" @click="collectPic(picture.id)">
                  </i>
                  <i v-else class="el-icon-star-on" style="font-size: 20px; cursor: pointer" @click="cancelCollectPic(picture.id)">
                  </i>
                  <span style="font-size: 15px;">
